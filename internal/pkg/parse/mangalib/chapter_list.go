...
// GetChapterListUrlByMangaID получает список url глав
func (mlc mangaLibController) GetChapterListUrlByMangaID(ctx context.Context, mangaID uuid.UUID) ([]string, error) {
	...
	return mlc.GetChapterListUrlByMangaUrl(ctx, mainMangaUrl)
}

func (mlc mangaLibController) GetChapterListUrlByMangaUrl(ctx context.Context, mainMangaUrl string) ([]string, error) {
